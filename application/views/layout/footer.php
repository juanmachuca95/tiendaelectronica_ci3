...
<script src="<?=base_url()?>/assets/js/validation.js"></script>
    ...
    <div class="row pt-4">
        ...
        <ul class="list-unstyled">
            ...
            <li>
            <p>
            <a href="<?=base_url()?>"><img style="width: 40px;" src="<?=base_url()?>assets/img/icons/t.png" alt="twitter"></a>
            </li>
            <li>
            <p>
            <a href="<?=base_url()?>"><img style="width: 40px;" src="<?=base_url()?>assets/img/icons/y.png" alt="youtube"></a>
            </li>
        </ul>
